<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-slate-400">Health and call logs for SentePro's platform-wide payment gateways</p>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
                        ...
                        <div class="rounded-xl bg-slate-800/60 px-4 py-3">
                            <div class="flex flex-wrap items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p class="text-sm text-slate-400">{{ $provider->environment }}</p>
                                </div>
            ...
            <div class="rounded-2xl bg-slate-900 p-6 shadow-sm ring-1 ring-white/10">
                ...
                <p class="text-sm text-slate-400">Latest 200</p>
                        ...
                        <tbody>
                            @forelse ($logs as $log)
                                <tr class="border-t border-white/10">
                                    <td class="py-2 pr-4">{{ $log->gatewayProvider->provider->label() }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="py-4 text-slate-400">No gateway calls logged yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
