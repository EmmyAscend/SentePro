...
<body class="font-sans bg-slate-950 text-white">
    <div class="mx-auto flex min-h-screen max-w-lg items-center justify-center px-4 py-12">
        <div class="w-full rounded-3xl bg-slate-900 p-8 text-center shadow-2xl ring-1 ring-white/10">
            <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-lime-400/20 text-lime-300">
            ...
            <div class="mt-6 space-y-2 rounded-2xl bg-slate-800 p-5 text-sm ring-1 ring-white/10">
