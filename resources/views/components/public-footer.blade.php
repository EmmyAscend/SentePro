...
<footer class="border-t border-white/10 py-12">
    ...
    <div class="mx-auto mt-10 flex max-w-6xl flex-col border-t border-white/10 px-4 pt-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:gap-1 sm:px-6 lg:px-8 lg:text-xl">
