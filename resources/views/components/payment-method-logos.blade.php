...
@endphp
<div {{ $attributes->merge(['class' => "grid grid-cols-3 place-items-center gap-x-0.5 gap-y-0.5 sm:flex sm:flex-wrap sm:items-center sm:$justify sm:gap-x-2 sm:gap-y-2"]) }}>
