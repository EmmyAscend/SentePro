...
@endphp
<div {{ $attributes->merge(['class' => "grid grid-cols-3 place-items-center gap-x-[5px] gap-y-[5px] sm:flex sm:flex-wrap sm:items-center sm:$justify sm:gap-x-2 sm:gap-y-2"]) }}>
