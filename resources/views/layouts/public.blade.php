...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.bunny.net/css?family=dai-banna-sil:400,500,600,700|figtree:400,500,600|pacifico:400&display=swap" rel="stylesheet" />
        @vite(['resources/css/app.css', 'resources/js/app.js'])
    </head>
    <body class="font-theme bg-slate-950 text-white">
